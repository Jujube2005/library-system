...
// Staff routes
router.get('/stats', auth_middleware_1.protect, (0, role_middleware_1.authorize)('staff'), loan_controller_1.getLoanStats);
router.get('/system', auth_middleware_1.protect, (0, role_middleware_1.authorize)('staff'), loan_controller_1.viewAllLoans);
